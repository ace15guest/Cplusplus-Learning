  ...
  // endl starts a new line similar to \n
  //std::flush flushes the buffer 
  //std::setw() sets the width 
  //std::right right justified
  //std::setfill(), header = <iomanip>
  //std::boolalpha or std::noboolalpha from 1/0 to true/false 
  //std::showpos or std::noshowpos show or dont show pos and neg numbers
  //std::dec, std::hex, std::oct
  //std::showbase
  //std::uppercase
  //std::scientific, std::fixed, header = <ios>
  //std::setprecision(#), header = <iomanip>
  //std::showpoint, header = <ios>
